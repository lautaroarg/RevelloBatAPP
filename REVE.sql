...
/****** Object:  Database [REVE]    Script Date: 27/12/2021 05:35:27 ******/
CREATE DATABASE [REVE]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'REVE', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL15.SQLEXPRESS\MSSQL\DATA\REVE.mdf' , SIZE = 8192KB , MAXSIZE = UNLIMITED, FILEGROWTH = 65536KB )
 LOG ON 
( NAME = N'REVE_log', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL15.SQLEXPRESS\MSSQL\DATA\REVE_log.ldf' , SIZE = 8192KB , MAXSIZE = 2048GB , FILEGROWTH = 65536KB )
...
ALTER DATABASE [REVE] SET QUERY_STORE = OFF
GO

ALTER DATABASE [REVE] SET  READ_WRITE 
GO
